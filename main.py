...
file_for_writing = os.path.abspath('\\Users\\slava\\OneDrive\\Рабочий стол\\PythonProgect\\1.txt')
base_path = os.getcwd()
location = os.path.abspath('\\Users\\slava\\OneDrive\\Рабочий стол\\PythonProgect')
